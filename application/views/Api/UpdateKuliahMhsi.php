...
<html>
    ...
    <body>
        <form onsubmit="return dosubmit()" >
            <div class="form-group">
                ...
                <input type="input" name="table" class="form-control" id="table" placeholder="table" value="kuliah_mahasiswa" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="">IPK</label>
                <input type="input" name="ipk" class="form-control" id="ipk" placeholder="ipk" value="" />
            </div>
            <div class="form-group">
    ...
    <script type="text/javascript">
        function dosubmit(){
            ...
            $.post("<?php echo site_url('index.php/api/updatekuliahmsi'); ?>",d, function( data ) {
