...
<html>
    ...
    <body>
        <form onsubmit="return dosubmit()" >
            ...
            <div class="form-group">
                <label for="">ID JNS DAFTAR</label>
                <input type="input" name="id_jns_daftar" class="form-control" id="id_jns_daftar" placeholder="id_jns_daftar" value="" />
            </div>
            <div class="form-group">
    ...
    <script type="text/javascript">
        function dosubmit(){
            ...
            $.post("<?php echo site_url('index.php/api/updatekuliahmhsii'); ?>",d, function( data ) {
